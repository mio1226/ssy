<template>
  <div>
    ...
    <el-dialog v-model="editDialog" title="编辑规则" width="500px">
      <el-form :model="editForm" label-width="100px">
        <el-form-item label="规则键">{{ editForm.ruleKey }}</el-form-item>
...
import { getRuleConfigs, updateRuleConfig } from '@/api/rule'
